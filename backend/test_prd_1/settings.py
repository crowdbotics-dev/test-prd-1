"""
Django settings for test_prd_1 project.
...
WSGI_APPLICATION = 'test_prd_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "test-prd Support <support@test-prd-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_1 API",
    "DESCRIPTION": "API documentation for test_prd_1 App",
    "VERSION": "v1",
}
